...
bool IMUProcessor::initialize(SyncPackage &package)
{
    ...
    m_kf->P().block<3, 3>(15, 15) = M3D::Identity() * 0.00001;
    m_kf->P().block<3, 3>(21, 21) = M3D::Identity() * 0.0001;
    m_kf->P().block<3, 3>(24, 24) = M3D::Identity() * 0.0001;
